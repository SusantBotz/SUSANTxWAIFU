...
from NOBITA import NOBITA as bot
from NOBITA import user_collection, collection, user_nguess_progress, user_guess_progress, SUPPORT_CHAT_ID as chat
...
async def mclaim(_, message: t.Message):
    ...
    try:
        ...
        if str(message.chat.id) != chat:
            join_button = InlineKeyboardMarkup([[InlineKeyboardButton("Join Here", url="https://t.me/+WLTHgUAvkYVmNTg9")]])
