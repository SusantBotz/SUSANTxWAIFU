...
# ---------------------------- CONSTANTS ---------------------------------
api_id = os.getenv("API_ID", "28269355")  # Fetch from environment variable
api_hash = os.getenv("API_HASH", "805b8c6577a8c30db439d901af544cac")   # Fetch from environment variable

TOKEN = os.getenv("TOKEN", "7556031866:AAFRrkLSeK23mne7AqlNjV-Z4eFmJzuWi3M")          # Fetch from environment variable
...
SUPPORT_CHAT_ID = os.getenv("SUPPORT_CHAT_ID", "-1002559277065") #USERNAME ONLY
...
# -------------------------- POWER SETUP --------------------------------
from NOBITA.unit.zyro_ban import *
from NOBITA.unit.zyro_sudo import *
from NOBITA.unit.zyro_react import *
from NOBITA.unit.zyro_log import *
from NOBITA.unit.zyro_send_img import *
from NOBITA.unit.zyro_rarity import *
# ------------------------------------------------------------------------
